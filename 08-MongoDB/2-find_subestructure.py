...
#8-Verificação dos laureados que tenham mais de dois prêmios
prize_triple = db.laureates.count_documents({
    'prizes.2':{
        '$exists': True
    }
})
...
9#Verificação dos laureados que tenham mais de três prêmios
prize_quaduple = db.laureates.count_documents({
    'prizes.3':{
        '$exists': True
    }
})
print(prize_quaduple)